...
def index():
    ...
    return render_template('users.html', headers=users_seach, page_data=page_data, total_pages=total_pages, search_name=search_name, search_gender=search_gender, current_page=page, rows=rows, labels=labels, values=values, count_data=count_data, users_seach=users_seach)
